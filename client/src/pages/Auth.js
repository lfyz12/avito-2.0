...
const Auth = observer(() => {
    ...
    const handleSubmit = async () => {
        if (isLogin) {
            ...
            await userStore.registration(email, password, name, role)
                .then(res => navigate(HOMEROUTER))
    ...
    return (
        <div className={`auth w-full max-w-[500px] mx-auto py-8 px-4 ${isLogin ? 'min-h-[60vh]' : 'min-h-[80vh]'} flex flex-col items-center`}>
            ...
            <div className="w-full bg-white rounded-xl shadow-sm p-6 sm:p-8 border border-gray-100">
                <div className="space-y-4 mb-6">
                    {isLogin ? (
                        ...
                        <>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Вы клиент/арендодатель</label>
