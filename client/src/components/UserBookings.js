// components/booking/UserBookings.jsx
...
const UserBookings = observer(() => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Мои бронирования</h1>
            ...
            {bookingStore.loading ? (
                ...
                <div className="bg-gray-50 rounded-xl p-8 text-center border border-gray-200">
                    ...
                    <p className="mt-1 text-gray-500">Вы еще не бронировали жилье</p>
                </div>
            ) : (
